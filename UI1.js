...
class UI1 extends/**GENİŞLETMEK*/ React.Component {
    state = {
        sayfa: '',
        klavye: false,
        klavyeH: 0
    ...
    componentDidMount() { //render dan sonra çalışır, sadece bir kez çalışır
        console.log('componentDidMount');
        Keyboard.addListener(
            and ? 'keyboardDidShow' : 'keyboardWillShow',
            (e) => {
        ...
        Keyboard.addListener(
            and ? 'keyboardDidHide' : 'keyboardWillHide',
            () => {
    ...
    componentDidUpdate() { //ekran güncellendikten sonra önce render, sonra bu çalışır
        console.log('componentDidUpdate');
        LayoutAnimation.easeInEaseOut();
    }

    componentWillUnmount() { //bileşen devreden çıkarıldığında ya da öldürüldüğünde bu çalışır
        console.log('componentWillUnmount');
    }


    signUpOnPress = () => { //ARROW FUNCTION
        //this.setState({ sayfa: 'signUp' });
        this.bizimSetState({ sayfa: 'signUp' });
        //console.log(sayfa);
        //this.forceUpdate();
    }
    signInOnPress = () => { //ARROW FUNCTION
    ...
    render() { //ekranda görünecek bileşenleri return eder (update olunca tekrar tekrar çalışır)
        /*return (
            <>
        ...
        */
        ...
        return (
            <>
                ...
                <View style={{ height: this.bizimState.klavye && !and ? this.bizimState.klavyeH : 0, width: W }} />
            </>
        );
    }
}
